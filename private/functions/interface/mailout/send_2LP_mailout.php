...
$log_dir =  $test ? base_path(WEB_ASSET_PATH . MAILOUT_LOG_PATH . 'test/') : base_path(WEB_ASSET_PATH . MAILOUT_LOG_PATH .'double_delay/');
...
require_once(base_path('private/functions/interface/mailout/includes/do_2lp_mailout.php?delay=true'));